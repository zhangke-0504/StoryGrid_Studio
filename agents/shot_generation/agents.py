...
""".strip().format(request_json=request.model_dump_json(indent=2, ensure_ascii=False))
    ...
    async def _run_react(self, request: ShotGenerationInput, verbose: bool = False) -> ShotAgentFinalResult:
        final_text = ""
    ...
    async def ainvoke(self, payload: Dict[str, Any] | ShotGenerationInput, verbose: bool = False) -> Dict[str, Any]:
    ...
    def invoke(self, payload: Dict[str, Any] | ShotGenerationInput, verbose: bool = False) -> Dict[str, Any]:
        try:
